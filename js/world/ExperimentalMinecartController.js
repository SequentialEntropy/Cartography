    ...
    moveAlongTrack(blockPos, railShape, remainingDistance) {
        ...
        if (remainingDistance < 1.0E-5) {
            ...
            if (currentVelocity.length() < 1.0E-5) {
                ...
                let predictedPosition = currentPosition.addVec3d(currentVelocity.normalize().multiplyConst(remainingDistance * (isSloped ? MathHelper.SQUARE_ROOT_OF_TWO : 1.0)));
...
class MoveIteration {
    constructor() {
        this.remainingMovement = 0.0;
        this.initial = true;
        this.slopeVelocityApplied = false;
